...
\alpha_1(L) =& \pi_L \times b_{L,1} = 0.1 \times 0.1 = 0.01\\\\
...
knitr::include_graphics("figures/sheet-2/FullProfileHMM.png")
```
:::
...
```{r, echo=FALSE, out.width="80%", fig.align='center'}
knitr::include_graphics("figures/sheet-2/PartialProfileHMM.png")
```
:::
#### {-}
