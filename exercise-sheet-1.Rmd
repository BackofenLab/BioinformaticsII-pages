...
P(\mathcal{O}|s_1) =& e_{L,3} \times e_{L,6}^2 \times e_{F,1} \times e_{F,6} \times e_{F,3} \times e_{F,4} = 0.1 \times 0.5^2 \times (\frac{1}{6})^4 = 1.9 \times 10^{-5} \\
P(\mathcal{O}|s_2) =& e_{F,3} \times e_{F,6}^2 \times e_{F,1} \times e_{F,6} \times e_{F,3} \times e_{F,4} = (\frac{1}{6})^7 = 3.57 \times 10^{-6} \\
...
[https://classroom.github.com/a/i_FyA5SR](https://classroom.github.com/a/i_FyA5SR)

### 2) Hidden Markov Models tasks:

[https://classroom.github.com/a/E-FEwES4](https://classroom.github.com/a/E-FEwES4)
